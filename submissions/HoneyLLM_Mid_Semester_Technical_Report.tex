...
\begin{tabularx}{\textwidth}{@{}p{1.7in} p{1.3in} p{1.0in} p{0.8in} X@{}}
...
\rowcolor{AccentGreen} \textbf{Honey-LLM Two-Tier Ensemble} & \textbf{Curated + Wild (889)} & \textbf{98.3\% (559/569)} & \textbf{0.0\% (0/320)} & \textbf{$\sim$2.1 ms (P50)} \\
\hline
\end{tabularx}
\end{table}
...
\begin{spacing}{1.0}
\noindent
\begin{enumerate}[label={[\arabic*]}, leftmargin=0.35in, itemsep=5pt]
