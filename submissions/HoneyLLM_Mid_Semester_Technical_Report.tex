...
\begin{enumerate}
    ...
    \item \textbf{Tier-2 Deep Moderation Sieve:} Ambiguous or high-threat prompts escalate to Llama-Guard 3 (8B)~\cite{llamaguard3} ($\sim$740 ms) executing a custom 8-category policy.
...
\textbf{Default Llama-Guard 3 (8B)}~\cite{llamaguard3} & JailbreakBench (100)~\cite{jailbreakbench2024} & 62.5\% (62/100) & 0.0\% (0/100) & 720 ms \\
\textbf{Custom Llama-Guard 3 (8B)}~\cite{llamaguard3} & JailbreakBench (100)~\cite{jailbreakbench2024} & 95.8\% (95/100) & 0.0\% (0/100) & 740 ms \\
